const en = {
    ...
    phrases: {
        ...
        search_for_the_page_you_want_to_go_to: 'Search for the page you want to go to.',
        short_description: 'Short Description',
        user_image: 'User Image',
        user_journey: 'User Journey',
        user_view_settings: 'User View Settings.',
        version_number: 'Version Number(v0.1.0)',
    },
    router: {
        home: "Home",
        user: {
