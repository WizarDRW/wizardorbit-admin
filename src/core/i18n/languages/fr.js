const fr = {
    ...
    phrases: {
        ...
        search_for_the_page_you_want_to_go_to: 'Recherchez la page à laquelle vous souhaitez accéder.',
    ...
    router: {
        ...
        user: {
            ...
            draft: "Brouillon",
            userOption: "Options utilisateur",
        },
        admin: {
            chapter: {
                main: "Chapitre",
        ...
        superUser: {
            main: 'Super-utilisateur',
            users: {
                main: 'Utilisatrice',
                list: "liste d'utilisateur",
            ...
            about: {
                ...
                list: 'Sur la liste',
                new: "Créer sur",
                edit: "Éditer à propos de"
            },
            release: {
                main: 'Libérer',
                list: 'Liste de publication',
                new: "Créer une version",
                edit: "Modifier la libération"
            },
            category: {
                chapter: 'Chapitre Catégories',
                news: 'Catégories de nouvelles',
                forum: 'Catégories de forum',
            }
        }
    },
    sideMenus: {
    ...
    // Contents 👇👇👇👇👇👇👇👇👇👇👇👇
    chapter: {
        new: 'Nouveau Chapitre'
    },
    news: {
        new: 'Nouvelles Informations'
    },
    forum: {
        new: 'Nouveau Forum'
    },
